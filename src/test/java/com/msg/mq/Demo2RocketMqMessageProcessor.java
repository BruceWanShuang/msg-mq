...
//@SubscribeService(topic = TopicEnum.Ticket, tags = {TagEnum.Ticket_INS}, sequence = 0)
public class Demo2RocketMqMessageProcessor extends RocketMqMessageProcessor {

	@Override
	protected RocketMqConsumeResult onMessage(String tag, String keys,
                                              MessageExt messageExt) {
		String msg = new String(messageExt.getBody());
		System.out.println("获取到的消息为----" + "2222----" + msg);
